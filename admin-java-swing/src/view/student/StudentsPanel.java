...
public class StudentsPanel extends JPanel implements MasterPanel {
    ...
    private JScrollPane buildTable() {
        String[] columns = {"ID", "Student #", "First Name", "Last Name", "Email", "Status", "Created", "Updated"};
    ...
    private void styleTable(JTable table) {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (column == 5 && value != null) {
                    ...
                    switch (status) {
                        ...
                        case "INACTIVE": c.setForeground(RED); break;
                        case "SUSPENDED": c.setForeground(ORANGE); break;
                    }
                } else {
        ...
        int[] widths = {50, 80, 120, 120, 180, 100, 100, 100};
    ...
    public void displayStudents(List<Student> students) {
        ...
        for (Student s : students) {
            Object[] row = {
                    ...
                    s.getEmail(),
                    s.getStatus().name(),
                    s.getCreatedAt() != null ? s.getCreatedAt().toLocalDate().toString() : "N/A",
                    s.getUpdatedAt() != null ? s.getUpdatedAt().toLocalDate().toString() : "N/A"
            };
