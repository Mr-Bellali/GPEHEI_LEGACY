...
CREATE TABLE teacher_module (
    ...
    module_id int,
    groupe_id INT,
    primary key (teacher_id, module_id,groupe_id),
...
CREATE TABLE projectSettings (
    ...
    CONSTRAINT uniq_filiere_promotion unique (promotion,filiere_id),
    constraint chk_check_max_min check (max_capacity>min_capacity)
);
